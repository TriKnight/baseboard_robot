...
static const char GETCRITICSCORE[] = "dwb_msgs/GetCriticScore";
  ...
  class GetCriticScoreRequest : public ros::Msg
  {
    ...
    const char * getType(){ return GETCRITICSCORE; };
    const char * getMD5(){ return "3fa15a34e918526f849ca1e20ce4e50a"; };
  ...
  class GetCriticScoreResponse : public ros::Msg
  {
    ...
    const char * getType(){ return GETCRITICSCORE; };
    const char * getMD5(){ return "85cd9210199e99fbf9e008c47a7fcf65"; };
