...
static const char GENERATETRAJECTORY[] = "dwb_msgs/GenerateTrajectory";
  ...
  class GenerateTrajectoryRequest : public ros::Msg
  {
    ...
    const char * getType(){ return GENERATETRAJECTORY; };
    const char * getMD5(){ return "c12676b96c40b5308f43475d17c2db1c"; };
  ...
  class GenerateTrajectoryResponse : public ros::Msg
  {
    ...
    const char * getType(){ return GENERATETRAJECTORY; };
    const char * getMD5(){ return "cfa75653fc81c4830452cf99eb524cb4"; };
