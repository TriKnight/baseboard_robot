...
static const char SCORETRAJECTORY[] = "dwb_msgs/ScoreTrajectory";
  ...
  class ScoreTrajectoryRequest : public ros::Msg
  {
    ...
    const char * getType(){ return SCORETRAJECTORY; };
    const char * getMD5(){ return "af4f903ab43c0b32f7ec1d0ded20f62b"; };
  ...
  class ScoreTrajectoryResponse : public ros::Msg
  {
    ...
    const char * getType(){ return SCORETRAJECTORY; };
    const char * getMD5(){ return "79d4637c00f492e5b6dd1b88aed58cd2"; };
