...
static const char GENERATETWISTS[] = "dwb_msgs/GenerateTwists";
  ...
  class GenerateTwistsRequest : public ros::Msg
  {
    ...
    const char * getType(){ return GENERATETWISTS; };
    const char * getMD5(){ return "9b565023e01bba3608d16ec34d67c081"; };
  ...
  class GenerateTwistsResponse : public ros::Msg
  {
    ...
    const char * getType(){ return GENERATETWISTS; };
    const char * getMD5(){ return "ca457e77ab95ba074b796555f7e74efe"; };
