...
static const char DEBUGLOCALPLAN[] = "dwb_msgs/DebugLocalPlan";
  ...
  class DebugLocalPlanRequest : public ros::Msg
  {
    ...
    const char * getType(){ return DEBUGLOCALPLAN; };
    const char * getMD5(){ return "48a8bd4b9e49f5026c60a04a25b5e74a"; };
  ...
  class DebugLocalPlanResponse : public ros::Msg
  {
    ...
    const char * getType(){ return DEBUGLOCALPLAN; };
    const char * getMD5(){ return "a386758bd988bd919d7a5a83bc925094"; };
