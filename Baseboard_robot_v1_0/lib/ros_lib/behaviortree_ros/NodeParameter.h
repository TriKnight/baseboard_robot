#ifndef _ROS_behaviortree_ros_NodeParameter_h
#define _ROS_behaviortree_ros_NodeParameter_h
...
namespace behaviortree_ros
{
  ...
  class NodeParameter : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "behaviortree_ros/NodeParameter"; };
