...
namespace mir_msgs
{
  ...
  class IOs : public ros::Msg
  {
    ...
    IOs():
      ...
      status(0),
      num_inputs(0),
      input_state_length(0), input_state(NULL),
      num_outputs(0),
      output_state_length(0), output_state(NULL),
      ip(""),
      error("")
    {
    }
    ...
    const char * getType(){ return "mir_msgs/IOs"; };
    const char * getMD5(){ return "6266405913b096bf8e69b775d090b781"; };
