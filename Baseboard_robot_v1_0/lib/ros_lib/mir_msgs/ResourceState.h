...
namespace mir_msgs
{
  ...
  class ResourceState : public ros::Msg
  {
    ...
    ResourceState():
      assigned_length(0), assigned(NULL),
      type(0),
      path_idx(0),
      distance(0),
      collision_point(),
      queue_length(0), queue(NULL),
      name(""),
      guid("")
    {
    }
    ...
    const char * getType(){ return "mir_msgs/ResourceState"; };
    const char * getMD5(){ return "df6513b10e65bfe7ec44f469810ded59"; };
